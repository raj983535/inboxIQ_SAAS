  ...
  return (
    <div className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16">
      <div className="text-center max-w-3xl mx-auto space-y-4">
        ...
        {/* Currency Switcher */}
        <div className="pt-4 inline-flex items-center p-1 rounded-xl bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700">
          <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <Card className="border-2 border-emerald-500 shadow-2xl relative bg-white dark:bg-neutral-900 flex flex-col justify-between">
          ...
          <CardContent className="p-8 sm:p-10 space-y-8 pt-10">
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-bold text-neutral-900 dark:text-white">InboxIQ Pro</h2>
              ...
              <div className="pt-4 flex items-baseline justify-center gap-1">
                <span className="text-5xl font-black text-neutral-900 dark:text-white">{facultyPlan.formatted}</span>
          ...
          <div className="p-8 pt-0 space-y-3">
            <Link href="/sign-up" className="block">
              <Button size="lg" className="w-full text-base py-3.5 shadow-lg shadow-emerald-600/25">
        ...
        <Card className="border border-amber-300 dark:border-amber-800 shadow-xl relative bg-white dark:bg-neutral-900 flex flex-col justify-between">
          ...
          <CardContent className="p-8 sm:p-10 space-y-8 pt-10">
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-bold text-neutral-900 dark:text-white">InboxIQ Student</h2>
              <p className="text-xs sm:text-sm text-neutral-500 dark:text-neutral-400">
                Special accessible tier for college students, scholars, and interns.
              </p>
              <div className="pt-4 flex items-baseline justify-center gap-1">
                <span className="text-5xl font-black text-neutral-900 dark:text-white">{studentPlan.formatted}</span>
          ...
          <div className="p-8 pt-0 space-y-3">
            <Link href="/sign-up" className="block">
              <Button size="lg" variant="secondary" className="w-full text-base py-3.5 border border-neutral-300 dark:border-neutral-700">
