  ...
  return (
    <div className="p-6 sm:p-10 space-y-6 max-w-7xl mx-auto w-full text-white">
      <div className="flex items-center justify-between pb-4 border-b border-neutral-800">
        <div>
          <h1 className="text-2xl font-bold">Report Execution Metadata</h1>
          <p className="text-xs text-neutral-400">
            Delivery confirmation to Gmail and PDF upload status to Google Drive. (Raw email text is not stored)
          </p>
        </div>
        <Button size="sm" variant="outline" onClick={fetchReports} loading={loading} className="text-white border-neutral-700 bg-neutral-800">
